# Home page route --> All views (index, login , ...) functions go into this file; Login view function logic;
# Logout view function; @login\_required decorator; Redirect to "next" page; User profile view function
...
def index():
    ...
    # return render_template('index.html', user=user)  # Without the Title argument to check the index smartness
